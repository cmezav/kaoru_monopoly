...
function renderCardsEditor(){
  ...
  title('Cartas de Suerte');board.cards.chance.forEach((card,i)=>add(card,`Suerte ${i+1}`,defaultCards.chance[i]));
  title('Cartas de Evento');board.cards.community.forEach((card,i)=>add(card,`Evento ${i+1}`,defaultCards.community[i]));
}
