...
community:[
{text:'El banco te cobró dos veces. Recupera 200.',effect:'receive',amount:200},
{text:'Encontraste dinero en una chaqueta vieja. Cobra 100.',effect:'receive',amount:100},
{text:'Es tu cumpleaños. Cada rival activo te entrega 75.',effect:'birthday',amount:75},
{text:'Compraste entradas para el grupo. Paga 50 a cada rival activo.',effect:'everyone',amount:50},
{text:'Ganaste un concurso de cosplay. Cobra 200.',effect:'receive',amount:200},
{text:'Tu pedido llegó incompleto. El banco te devuelve 150.',effect:'receive',amount:150},
